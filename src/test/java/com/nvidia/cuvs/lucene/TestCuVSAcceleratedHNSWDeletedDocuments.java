...
public class TestCuVSAcceleratedHNSWDeletedDocuments extends LuceneTestCase {

  private static final Logger LOG =
      LoggerFactory.getLogger(TestCuVSAcceleratedHNSWDeletedDocuments.class);
    ...
    try (Directory directory = newDirectory()) {
      ...
      try (DirectoryReader reader = DirectoryReader.open(directory)) {
        ...
        for (ScoreDoc hit : hits) {
          ...
          LOG.trace("Found non-deleted document: {}, score: {}", id, hit.score);
        }
    ...
    try (Directory directory = newDirectory()) {
      ...
      try (DirectoryReader reader = DirectoryReader.open(directory)) {
        ...
        for (ScoreDoc hit : hits) {
          ...
          LOG.trace("Found document with vector: {}, score: {}", id, hit.score);
        }
